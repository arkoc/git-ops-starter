...
GitOps Starter is addressing ABC, Inc. company's all infrastructure needs. Before diving in, read the story of how this repository was born.
...
- GitOps Starter Project is a way for someone to contribute to the GitOps community and help advance the state of the art in GitOps. By sharing their knowledge and experience with others, the creator of a GitOps Starter Project can help others learn and benefit from GitOps.
